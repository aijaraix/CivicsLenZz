...
# Remove the one inside MapVisual
target = """                 <div className="flex-1 relative">
                    <MapVisual officials={result} levelFilter={level} />
                    {/* State Dropdown */}
                {level === 'State' && (
...
replacement = """                 <div className="flex-1 relative">
                    <MapVisual officials={result} levelFilter={level} />
                 </div>"""
