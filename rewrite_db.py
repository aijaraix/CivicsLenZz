...
# Find everything from "export const trackedOfficials" to "];"
start = text.find("export const trackedOfficials: TrackedOfficial[] = [")
end = text.find("];\n\nexport const activityItems: ActivityItem[] = [", start)

if start != -1 and end != -1:
    old_array = text[start:end+2]
