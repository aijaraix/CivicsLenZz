...
export const MASTER_CONTRACT_FIELD_SPECS: FieldTemplateSpec[] = [
  // 1. CORE IDENTITY & BIOGRAPHY (10 fields)
  ...
  // 2. SEAT & OFFICE DETAILS (8 fields)
  ...
  { key: 'office_jurisdiction_bounds', label: 'Constitutional / Charter Authority Basis', category: 'SEAT_OFFICE_DETAILS', description: 'Statutory or constitutional section defining powers of office', requiredFor: ALL_OFFICE_TYPES },

  // 3. EDUCATION & CAREER HISTORY (10 fields)
  ...
  // 6. CAMPAIGN FINANCE ITEMIZED (12 fields)
  ...
  // 7. LEGISLATIVE / VOTING RECORD (10 fields)
  ...
  // 10. PUBLIC STATEMENTS & POSITIONS (10 fields)
  ...
  // 11. ETHICS & FINANCIAL DISCLOSURES (10 fields)
  ...
  // 12. PUBLIC COURT / LEGAL RECORDS (8 fields)
  ...
  // 14. CONTACT & OFFICIAL PRESENCE (8 fields)
  ...
  { key: 'contact_district_office_addresses', label: 'Local District Office Locations', category: 'CONTACT_OFFICIAL_PRESENCE', description: 'Full directory of local district constituent service office addresses and phone lines', requiredFor: ALL_OFFICE_TYPES },
  ...
  // 15. GEOSPATIAL & DISTRICT INFO (8 fields)
