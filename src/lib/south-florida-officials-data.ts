...
export function getPreseededSouthFloridaOfficials(): SouthFloridaSeedOfficial[] {
  ...
  const coreOfficials: SouthFloridaSeedOfficial[] = [
    ...
    // State Legislators
    { person_uuid: 'person_shevrin_jones', seat_uuid: 'seat_fl_senate_34', name: 'Shevrin D. "Shev" Jones', title: 'State Senator', jurisdiction: 'Miami-Dade / Broward', office_type: 'STATE_LEGISLATOR', level: 'State', party: 'Democratic', district: 'District 34', region: 'SOUTH_FLORIDA', completion: 100, photoUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/1/1f/Shevrin_Jones_%28cropped%29.jpg/800px-Shevrin_Jones_%28cropped%29.jpg' },
    { person_uuid: 'person_barbara_sharief', seat_uuid: 'seat_fl_senate_35', name: 'Barbara Sharief', title: 'State Senator', jurisdiction: 'Broward County', office_type: 'STATE_LEGISLATOR', level: 'State', party: 'Democratic', district: 'District 35', region: 'SOUTH_FLORIDA', completion: 100, photoUrl: 'https://flsenate.gov/PublishedContent/Senators/2024-2026/Photos/s35_official.jpg' },
    ...
    { person_uuid: 'person_jason_pizzo', seat_uuid: 'seat_fl_senate_37', name: 'Jason Pizzo', title: 'State Senator', jurisdiction: 'Broward / Miami-Dade', office_type: 'STATE_LEGISLATOR', level: 'State', party: 'Nonpartisan', district: 'District 37', region: 'SOUTH_FLORIDA', completion: 100, photoUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/2/2f/Jason_Pizzo.jpg/800px-Jason_Pizzo.jpg' },
  ...
  // STRICT PURGE: Never generate synthetic officials from name permutation loops.
  // Return only verified, authentic core officials.
...
// BANNED: getExpandedSouthFloridaSeats previously generated 1,000 synthetic fake records.
// Return empty array to protect data integrity until real municipal scrapers harvest seats.
