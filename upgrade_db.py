...
# Add Enterprise Fields to the type
new_fields = """  keyStaff?: { name: string; role: string }[];
  ...
  lobbyingConnections?: { firm: string; amount: number; description: string }[];"""

text = text.replace("  keyStaff?: { name: string; role: string }[];", new_fields)

# Re-inject Trump data with enterprise data
new_trump = """    slug: 'donald-trump', name: 'Donald Trump', title: 'President of the United States', level: 'Federal', party: 'Republican', district: 'United States', color: '#dc2626', initials: 'DT', score: 85, promises: 54, bills: 6, votes: 0, 
    ...
    netWorth: '$4.5 Billion - $5.5 Billion (Forbes/Bloomberg Estimates, 2024)',
    campaignFinance: { totalRaised: 1045000000, totalSpent: 985000000, cashOnHand: 60000000, asOf: 'November 2024', pacPercentage: 65, individualPercentage: 35 },
    businessesOwned: [
      { name: 'The Trump Organization', role: 'Chairman / President (Former)', status: 'Active (Managed by family)', years: '1971 - Present', description: 'Global conglomerate encompassing real estate development, hotels, casinos, and golf courses.' },
      { name: 'Trump Media & Technology Group', role: 'Majority Shareholder', status: 'Active, Publicly Traded (DJT)', years: '2021 - Present', description: 'Parent company of Truth Social.' },
      { name: 'Trump Hotels & Casino Resorts', role: 'Chairman', status: 'Defunct (Bankruptcies 2004, 2009, 2014)', years: '1995 - 2014', description: 'Publicly traded company that owned Trump Taj Mahal, Trump Plaza, and Trump Marina.' },
      { name: 'Trump University', role: 'Founder', status: 'Defunct (Settled lawsuit)', years: '2005 - 2010', description: 'For-profit education company.' },
      { name: 'Trump Model Management', role: 'Founder', status: 'Defunct', years: '1999 - 2017', description: 'New York City-based modeling agency.' },
      { name: 'New Jersey Generals', role: 'Owner', status: 'Defunct (USFL folded)', years: '1983 - 1985', description: 'Professional American football team in the USFL.' }
    ],
    propertiesRealEstate: [
      { name: 'Mar-a-Lago Club', location: 'Palm Beach, FL', estimatedValue: '$250M - $300M' },
      { name: 'Trump Tower', location: 'New York, NY', estimatedValue: '$200M - $250M' },
      { name: 'Trump National Doral Miami', location: 'Miami, FL', estimatedValue: '$250M - $300M' },
      { name: '40 Wall Street', location: 'New York, NY', estimatedValue: '$150M - $200M' },
      { name: 'Trump Turnberry', location: 'Ayrshire, Scotland', estimatedValue: '$100M+ (Estimated)' }
    ],
    legalHistory: [
      { caseName: 'New York v. Trump (Civil Fraud)', date: 'Feb 2024', outcome: 'Found liable', description: 'Judgment of over $450 million for fraudulently inflating asset values.' },
      { caseName: 'New York v. Trump (Hush Money)', date: 'May 2024', outcome: 'Convicted on 34 felony counts', description: 'Falsifying business records related to payments made to Stormy Daniels.' },
      { caseName: 'E. Jean Carroll v. Donald J. Trump', date: 'Jan 2024', outcome: 'Found liable for defamation and battery', description: 'Ordered to pay $83.3 million in defamation damages.' },
      { caseName: 'United States v. Donald J. Trump (Election Interference)', date: 'Pending', outcome: 'Pending', description: 'Federal indictment related to the events of Jan 6 and efforts to overturn the 2020 election.' },
      { caseName: 'United States v. Donald J. Trump (Classified Documents)', date: 'Dismissed (Appealed)', outcome: 'Dismissed by Judge Cannon', description: 'Federal indictment concerning retention of national defense information.' }
    ],
    previousOffices: [
      { title: '45th President of the United States', years: '2017 - 2021' }
    ],
    affiliations: [
      { organization: 'Republican National Committee', role: 'De facto Leader' },
      { organization: 'Screen Actors Guild (SAG-AFTRA)', role: 'Former Member (Resigned 2021)' }
    ],
    detailedPromises: [
...
if match:
    ...
    text = text.replace(old_content, new_trump)
